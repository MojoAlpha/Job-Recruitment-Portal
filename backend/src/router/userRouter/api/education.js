...
const { addEducationalQual,
        removeEducationalQual,
        updateEducationalQual } = require('../../../services/userServices/education');
...
router.post('/', [
    body('degree', 'insti', 'year').notEmpty().withMessage('Fields Should Be Specified!!'),
...
/*  PUT Route :- Updating Educational Qualifications
    ...
    Res Body :- {msg: "...", success: true} , if Sucessfully Updated
                {err: "...", success: false} , if Any Error Occurs */
router.put('/', [
    body('degree', 'insti', 'year', 'index').notEmpty().withMessage('Fields Should Be Specified!!'),
