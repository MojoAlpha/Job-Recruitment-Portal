...
const { selectedNotify, 
        closeNotify } = require('../../../services/NotfiyServices/vacancyNotify')
const { getVacApplicants, 
        vacancyApply, 
        vacancyClose, 
        vacancySelect, 
        getCompanyVacancy,
...
/*  GET Route :- Getting All The Vacancies Of A Company
...
/*  POST Route :- To Select An Applicant, Only Company is Authorized
    Req Body :- { userId }
    Res Body :- {msg: "...", success: true} , if Sucessfully Selected
                {err: "...", success: false} , if Any Error Occurs */
