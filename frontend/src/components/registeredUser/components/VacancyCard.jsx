...
const VacancyCard = (props) => {
    ...
    const vacancyList = vacancies.map(vacancy => <ListItemWithBtn text={vacancy.desig} imgUrl={`http://localhost:8000/logo/${props.logo}`} btnText="view" id={vacancy._id} isOpen={vacancy.isOpen} />)
    return (
