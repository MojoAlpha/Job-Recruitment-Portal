    ...
    return (
        <React.Fragment>
            ...
            <div className="container-fluid d-flex no-gutters p-0" >
                <div className="d-none d-md-block col-3 px-2 py-4 px-lg-4 px-xl-5 text-center bg-white shadow border-right" style={{position:'fixed',top:'88px',left:0,height:'100%'}}>
                ...
                <div className="col-12 col-md-9 row bg-gray px-4 pt-4" style={{marginLeft:'25%'}}>
                    <NewsFeed/>
                    {/* <GridLayout/> */}
